    ...
    <section class="section">
      ...
      <div class="searchBox">
        <el-form :model="searchFunction" label-width="100px" size="mini">
          <ul class="searchList">
            ...
            <li>
              <el-form-item>
                <el-button type="primary" plain icon="el-icon-refresh" size="mini" @click="clear()">
                  {{ $t('message.Reset') }}</el-button>
                <el-button type="primary" plain icon="el-icon-search" @click="searchFunctions()">
      ...
      <div class="gridBox mt20">
        <el-table :data="functions" border style="width: 100%">
          <el-table-column align="center" prop="gnbm" :label="$t('message.FunctionsNum')" width="300px"
            show-overflow-tooltip></el-table-column>
          <el-table-column align="left" header-align="center" show-overflow-tooltip prop="gnmc"
            :label="$t('message.FunctionsName')"></el-table-column>
        </el-table>
