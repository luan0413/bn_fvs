      ...
      <section class="section">
        ...
        <div class="gridBox mt20">
          <el-table highlight-current-row :data="LogData" border>
            ...
            <el-table-column align="center" prop="function" :label="$t('message.FunctionName')" width="150"></el-table-column>
            <el-table-column align="center" prop="kzqbsm" :label="$t('message.ControllerNum')" width="120"></el-table-column>
        ...
        <el-dialog :title="$t('message.Details')" :visible.sync="logDialog" width="900px">
