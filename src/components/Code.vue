<template>
      ...
      <section class="section">
        ...
        <div class="btnBox">
					<el-button type="primary" class="operateBtn" plain icon="el-icon-plus" @click="showCodeDialogs()">{{ $t('message.Insert') }}</el-button>
				</div>
        <div class="gridBox">
					<el-table	:data="CodeData" border	style="width: 100%">
						<el-table-column align="center"	prop="dmlbsm"	:label="$t('message.CodesCategory')" show-overflow-tooltip></el-table-column>
						<el-table-column align="center"	prop="dm"	:label="$t('message.Codes')" show-overflow-tooltip></el-table-column>
            <el-table-column align="center"	prop="dmsm"	:label="$t('message.CodesExplain')" show-overflow-tooltip></el-table-column>
      ...
      <el-dialog :title="title" :visible.sync="showCodeDialog" width="300px">
        <span>
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button @click="showCodeDialog = false" size="mini" style='margin-right: 10px;'>{{ $t('message.Cancel') }}</el-button>
        </span>
      </el-dialog>
		</div>
</template>
