<template>
  <div>
    ...
    <div class="content FogAreaMonitor">
      ...
      <section class="section">
        ...
        <div class="tab-box">
          <div class="tabBox" v-show="showtabbar" ref="showtabbar">
            <!--雾灯控制，控制器参数查询，下发按钮-->
            <el-button :style="{display: disController}" :title="$t('message.SearchControllerParameter')" size="mini" class="tableBtnImg" icon="el-icon-printer" @click="showSyncDialog()"></el-button>
            ...
            <el-tabs v-model="activeTabName" @tab-click="handleClick">
                  ...
                  <div class="bana-information">
                    ...
                    <div class="bana-information-content">
                      <ul class="inf readonly">
                        <li>
                          <span>{{ $t('message.FogAreaName') }}：</span><input type="text" readonly v-model="fogArea.wqmc" :title="fogArea.wqmc" />
                        </li>

                        <li>
                          <span>{{ $t('message.VisibilityGrade') }}：</span><input type="text" readonly v-model="fogArea.njddj" />
                        </li>
                        <li>
                      ...
                      <ul class="inf readonly">
                        <li>
                          <span>{{ $t('message.Visibility') }}：</span><input type="text" readonly v-model="fogArea.njd" />
                          <span class="unit">m</span>
                        </li>
                        <li>
                          <span>{{ $t('message.VisibilityDescription') }}：</span><input type="text" readonly v-model="fogArea.njddjms" />
                        </li>
                        <li>
                          <span>{{ $t('message.FogAreaWeather') }}：</span><input type="text" readonly v-model="fogArea.lmzt" />
                        </li>
                        <li>
                ...
                <div class="second">
                  <div class="fogAreaBox">
                        ...
                        <div class="bana-information-content">
                          <el-form :model="fogArea" size="mini">
                            <ul class="lampReadonly">
                              <li>
                                <el-form-item :label="$t('message.LightGread')+'：'" prop="wdlddj" v-if="lamp.wdlddjxszt">
                                  <el-input readonly v-model="fogArea.wdlddj"></el-input>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.FoglightLuminance')+'：'" prop="wdld" v-if="lamp.wdldxszt">
                                  <el-input readonly v-model="fogArea.wdld"></el-input>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.LightsONDuration')+'：'" prop="ldsc" v-if="lamp.ldscxszt">
                                  <el-input readonly v-model="fogArea.ldsc"></el-input>
                                  <span class="unit">ms</span>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.LightsOFFDuration')+'：'" prop="mdsc" v-if="lamp.mdscxszt">
                                  <el-input readonly v-model="fogArea.mdsc"></el-input>
                                  <span class="unit">ms</span>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.FlickerFrequency')+'：'" v-if="lamp.ssplxszt" :title="fogArea.ssplsm">
                              ...
                              <li>
                                <el-form-item :label="$t('message.RedTimeLengthening')+'：'" prop="hdys" v-if="lamp.hdysxszt">
                                  <el-input readonly v-model="fogArea.hdys"></el-input>
                                  <span class="unit">s</span>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.DeadZoneDuration')+'：'" prop="mqys" v-if="lamp.mqysxszt">
                                  <el-input readonly v-model="fogArea.mqys"></el-input>
                                  <span class="unit">s</span>
                                </el-form-item>
                              </li>
                              <li>
                                <el-form-item :label="$t('message.RedLightsNumber')+'：'" prop="hsjsdzsl" label-width="108px" v-if="lamp.hsjsdzslxszt">
                    ...
                    <div class="wdBtn">
                      ...
                      <el-switch v-model="sfds" active-color="#13ce66" inactive-color="#ff4949" @change="updateFogAreaTimer"></el-switch>
                      <el-button type="primary" style="width: 80px" icon="el-icon-refresh" :disabled="!isFlag" @click="showSetDialog(2)">手动干预</el-button>
                      <el-button type="primary" style="width: 80px" icon="el-icon-refresh" :disabled="isFlag" @click="showSetDialog(1)">取消干预</el-button>
                    </div>
                  </div>
                </div>
              </el-tab-pane>
              ...
              <el-tab-pane :label="$t('message.ControllerChange')" name="tabRelay">
                <div class="bana-information" style="width: 50%;">
                  ...
                  <div class="bana-information-content" style="display: flex;">
                    <ul class="controllerChange">
                      <li>
                        <span>{{ $t('message.WorkState')+'：' }}</span><input type="text" readonly v-model="fogArea.jdqgzmssm">
                      </li>
                    </ul>
                ...
                <div class="bana-information" style="width: 48%;margin-left: 2%;">
                  ...
                  <div class="bana-information-content mt20">
                    <el-button type="primary" icon="el-icon-circle-check-outline" :disabled="disMain" @click="mainController">{{$t('message.mainController')}}</el-button>
                    <el-button type="primary" icon="el-icon-circle-check-outline" :disabled="disStandby" @click="standbyController">{{$t('message.standbyController')}}</el-button>
                    <el-button type="danger" icon="el-icon-circle-close-outline" :disabled="disOff" @click="allBreak">{{$t('message.allBreak')}}</el-button>
                  </div>
                </div>
              </el-tab-pane>
              <!--郑州项目没用先注释-->
                  ...
                  <div class="xspBox">
                    ...
                    <div class="bana-information" style="width: 93%;flex-grow: 1;">
                      ...
                      <div class="bana-information-content">
                        ...
                        <div class="fl ml50 mt20">
                          <el-button type="primary" icon="el-icon-refresh" @click="setLeds(2)">{{ $t("message.Issue") }}</el-button>
                          <el-button type="primary" :disabled="disLedAuto" icon="el-icon-rank" @click="setLeds(1)">自动</el-button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <el-tab-pane label="号角控制" name="tabHorn">
                <div class="fifth tabHorn">
                  <div class="bana-information">
                    ...
                    <div class="fl ml50 mt20">
                      <el-button type="primary" class="fl" icon="el-icon-refresh" @click="setHorns(2)">{{ $t("message.Issue") }}</el-button>
                      <el-button type="primary" class="fl" icon="el-icon-rank" :disabled="disHornAuto" @click="setHorns(1)">自动</el-button>
                    </div>
                  </div>
                </div>
              </el-tab-pane>
                ...
                <div class="sixth tabLight">
                  <div class="jdBox">
                    ...
                    <div class="bana-information" style="width: 93%;flex-grow: 1;">
                      ...
                      <div class="fl ml50 mt20">
                        <el-button type="primary" icon="el-icon-refresh" @click="setLights(2)">{{ $t("message.Issue") }}</el-button>
                        <el-button type="primary" icon="el-icon-rank" @click="setLights(1)" :disabled="disLightAuto">自动</el-button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <el-tab-pane label="相机控制" name="tabCamera">
                <div class="bana-information tabCamera">
                  ...
                  <div class="fl mt10 ml50">
                    <el-button type="primary" class="fl" icon="el-icon-refresh" @click="setCameras(2)">{{ $t("message.Issue") }}</el-button>
                    <el-button type="primary" class="fl" icon="el-icon-rank" :disabled="disCameraAuto" @click="setCameras(1)">自动</el-button>
                  </div>
                </div>
              </el-tab-pane>
              <el-tab-pane label="模拟能见度数据" name="tabVisibility">
                <div class="bana-information tabVisibility" style="width: 100%;flex-grow: 1;">
                  ...
                  <div class="fl ml50 mt20">
                    <el-button type="primary" @click="setVisibilityDialog" icon="el-icon-refresh">{{ $t("message.Issue") }}</el-button>
                  </div>
                </div>
              </el-tab-pane>
      ...
      <el-dialog :title="$t('message.FogAreaController')" :visible.sync="setdialog" width="1100px">
        <template>
          <el-row>
            <el-col :span="24">
              <div class="wdCons">
                <div class="bana-informations" v-loading="loading" :element-loading-text="$t('message.Synchronization')">
                  ...
                  <div class="bana-information-contents">
                    <div class="wukzqBox">
                      <el-table :data="controllers" border tooltip-effect="dark" highlight-current-row>
                        <el-table-column align="center" prop="kzqmc" :label="$t('message.ControllerName')" min-width="90" show-overflow-tooltip>
                        </el-table-column>
                        <el-table-column prop="kzqbsm" align="center" :label="$t('message.ControllerNum')" min-width="100">
                        </el-table-column>
                        <el-table-column align="center" prop="wdkzsm" :label="$t('message.FoglightControl')" min-width="90" show-overflow-tooltip>
                        </el-table-column>
                        <el-table-column align="center" prop="wdld" :label="$t('message.FoglightLuminance')" min-width="70">
                        </el-table-column>
                        <el-table-column align="center" prop="ldsc" :label="$t('message.LightsONDuration')+'(ms)'" min-width="100">
                        </el-table-column>
                        <el-table-column align="center" prop="mdsc" :label="$t('message.LightsOFFDuration')+'(ms)'" min-width="100">
                        </el-table-column>
                        <el-table-column align="center" prop="hdys" :label="$t('message.RedTimeLengthening')+'(s)'" min-width="90">
                        </el-table-column>
                        <el-table-column align="center" prop="mqys" :label="$t('message.DeadZoneDuration')+'(s)'" min-width="90">
                        </el-table-column>
      ...
      <!--下发控制显示界面  -->
      <el-dialog :title="controllDialogTitle" class="fogAreaMonitor" :visible.sync="controllDialog" width="1000px" :close-on-click-modal='false'>
        <div class="fogAreaBox" v-if="controllDialogTop">
          ...
          <div class="fogArea_lamp_inf mt20 lampInput">
            <div class="bana-information" style="height: auto !important;margin-bottom: 20px;" v-if="lampZt.wdkzxszt||lampZt.wdlddjxszt||lampZt.wdldxszt||lampZt.ssplxszt||lampZt.zkbxszt||lampZt.ldscxszt||lampZt.mdscxszt||lampZt.hdysxszt||lampZt.mqysxszt||lampZt.hsjsdzslxszt">
              <div class="bana-title">{{ $t('message.ParamAdjustment') }}</div>
              <div class="bana-information-content">
                <el-form :disabled="lampConfigDisabled" :model="lampDialog" :rules="lampRules" ref="lampForm" size="mini" label-width="120px">
                  <ul class="lamp">
                    <li>
                      <el-form-item :label="$t('message.LightGread')+'：'" prop="wdlddj" v-if="lampZt.wdlddjxszt">
                        <el-select v-model="lampDialog.wdlddj" :placeholder="$t('message.PleaseSelect')" v-if="lamp.sspl != 1">
        ...
        <span slot="footer" class="dialog-footer" v-if="controllDialogTop">
          ...
          <el-button type="primary" @click="setControllersConfig" size="mini" style="padding: 7px 15px;">{{$t('message.Sure')}}</el-button>
          <el-button @click="close" size="mini" style="padding: 7px 15px;">{{$t('message.OFF')}}</el-button>
        </span>
      </el-dialog>
      <el-dialog :title="controllDialogSureTitle" class="fogAreaMonitor" :visible.sync="controllDialogSure" width="1000px" :close-on-click-modal='false' :show-close="false">
        <el-table :data="controllArray" style="width: 100%;" border v-loading="controllLoading" :fit="true" :row-style="tableRowStyle">
        ...
        <span slot="footer" class="dialog-footer" v-if="controllDialogSureTop">
          <el-button @click="controllDialogSure = false" size="mini" style="padding: 7px 15px;">{{$t('message.OFF')}}</el-button>
        </span>
        <span slot="footer" class="dialog-footer" v-else>
          <!-- 确定下发（能见度检测仪） -->
          <el-button type="primary" @click="setVisibility" size="mini" style="padding: 7px 15px;">{{$t('message.Sure')}}</el-button>
          <el-button @click="controllDialogSure = false" size="mini" style="padding: 7px 15px;">{{$t('message.OFF')}}</el-button>
        </span>
      </el-dialog>
    </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      Code.getCodeMap({ dmlb: Dictionary.CodeType.ControllerWorkMode },
    ...
    changeConfigEnabled(value) {
      this.lampConfigDisabled = value == Dictionary.ControllerWorkMode.Off || value == Dictionary.ControllerWorkMode.Auto;
    },
